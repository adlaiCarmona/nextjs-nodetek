//From: https://learnersbucket.com/examples/javascript/credit-card-validation-in-javascript/
...
export function verifyCard(number) {
    //Error messages
    const ccErrors = [];
